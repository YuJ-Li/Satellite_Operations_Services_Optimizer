...
class Satellite(models.Model):
    satelliteId = models.CharField(max_length=50, unique=True,primary_key=True)
...
class SatelliteSchedule(models.Model):
    ...
    scheduleID = models.CharField(max_length=50, unique=True,primary_key=True)
    activityWindow = models.DateTimeField()

class SatelliteTask(models.Model):
    TaskID = models.CharField(max_length=50, unique=True,primary_key=True)
...
class GroundStationRequest(models.Model):
    requestId = models.CharField(max_length=50, unique=True, primary_key=True)
...
class Image(models.Model):
    ...
    imageId = models.CharField(max_length=50, unique=True,primary_key=True)
...
class Outage(models.Model):
    outageId = models.CharField(max_length=50, unique=True,primary_key=True)
