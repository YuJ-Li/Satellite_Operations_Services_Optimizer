...
urlpatterns = [
    ...
    path('imagingTasks/', views.imaging_task_list),
    path('imagingTasks/<str:task_id>/', views.imaging_task_detail, name='imaging_task_detail'),
    ...
    path('globalTime/',views.getGlobalTime),
